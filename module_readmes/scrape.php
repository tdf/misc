...
foreach ($matches[1] as $name) {
	...
	$paras = explode("\n\n", $readme);
	$short = $paras[0];
	$modules[$name] = array($short, $readme);
...
foreach ($modules as $name => $info) {
	$text = head($name);
	$text .= "<p><a href=\"index.htm\">Return to module list</a> &nbsp; <a href=\"http://cgit.freedesktop.org/libreoffice/core/tree/{$name}\">Show cgit Tree</a></p>";
	$text .= "<p>&nbsp;</p>";
	$text .= "<pre>{$info[1]}</pre>\n";
	$text .= foot();
	echo " - {$name}.htm\n";
